 ...
 **/
public class DuckMessageEncoder extends MessageToMessageEncoder<DuckMessage> {

    MarshallingEncoder encoder;
    public DuckMessageEncoder() throws IOException {
        this.encoder = new MarshallingEncoder();
    }

    @Override
    protected void encode(ChannelHandlerContext ctx, DuckMessage msg, List<Object> list) throws Exception {
